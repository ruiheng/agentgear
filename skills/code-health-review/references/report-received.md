...
selector-aliases: action:code_health_review_report
---

# Code Health Review Report

If this session has a matching active `code_health_review_requested` request,
...
Retrieve `agentgear skill get code-health-review/review code-health-review/continue-1` only when the report's context requires the complete advisory-review contract.
