...
arrive, derive the review frame again; unchanged facts in your evidence ledger
may be reused per `multi-agent-protocol/evidence-ledger`, but conclusions may
not. Reinspect affected source, then scan the complete documents for
consistency.
