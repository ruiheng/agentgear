...
Follow the remembered guidance from `agentgear skill get prune-tech-design`. Run it only if you no longer remember the guidance or have evidence it changed.
