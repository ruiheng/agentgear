...
Use stable finding IDs from the review report. In the next artifact, make each addressed finding traceable to the affected sections. Do not edit reviewer-owned Evidence Index or Review Ledger state.
